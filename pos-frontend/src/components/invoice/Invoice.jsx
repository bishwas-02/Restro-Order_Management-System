      ...
      <div className="bg-white p-4 rounded-lg shadow-lg w-[400px]">
        ...
        <div ref={invoiceRef} className="p-4">
          ...
          <div className="mt-4 border-t pt-4 text-sm">
            <p><strong>Subtotal:</strong> ₹{orderInfo.billTotal.toFixed(2)}</p>
            <p><strong>Tax:</strong> ₹{orderInfo.billTax.toFixed(2)}</p>
            <p className="text-md font-semibold">
              <strong>Grand Total:</strong> ₹{orderInfo.billTotalWithTax.toFixed(2)}
            </p>
          </div>
